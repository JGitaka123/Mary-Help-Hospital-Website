...
export const timeline: Milestone[] = [
  ...
  {
    period: "2022",
    title: "Two operating theatres and a renal unit",
    description:
      "Two state-of-the-art operating theatres doubled surgical capacity, and the Renal Unit began providing dialysis close to home.",
  },
  {
    period: "2023",
...
export const values = [
  {
    letter: "S",
    name: "Service",
    description: "We put the interests of our patients and stakeholders first, offering not just treatment but emotional and spiritual support.",
  },
  {
    letter: "M",
    name: "Mindfulness",
    description: "We show care for the patient, their family, the community and the environment, attentive to each person's unique needs.",
  },
  {
    letter: "I",
    name: "Integrity",
  ...
  },
  {
    ...
    description: "We inspire our staff, stakeholders and community towards common goals through professional conduct and visionary leadership.",
  },
  {
    letter: "E",
    name: "Excellence",
    description: "We pursue continuous improvement in patient care, research and administration, measured by outcomes and patient satisfaction.",
  },
  {
    letter: "S",
    name: "Synergy",
    description: "We work together across departments, specialties and institutions so that every aspect of a patient's wellbeing is addressed.",
  },
];
